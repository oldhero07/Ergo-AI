/**
 * Pure video post-processing (smoothing, cycle counting, temporal detection) -
 * DOM-free math, consumed by the analysis pipeline and by vitest. Moved
 * verbatim from pipeline/shared.ts when the on-device backends were removed;
